...
Code style and contribution conventions for the byoe-react-examples workspace.
Coding agents receive this file via the include in [AGENTS.md](AGENTS.md); for a
map of the repository, see [ARCHITECTURE.md](ARCHITECTURE.md).
